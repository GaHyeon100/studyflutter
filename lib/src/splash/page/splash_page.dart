      ...
      body: Center(
        ...
        child: GetxListener<bool>(
            ...
            child: GetxListener<StepType>(
              stream: controller
                  .loadStep, // GetView<SplashController> - controller의 loadStep의 상태값을 듣겠다
              initCall: () {
                controller.loadStep(
                    StepType.dataLoad); //loadStep의 값을 StepType.dataLoad로 업데이트
              },
              listen: (StepType? value) {
                // StepType의 값을 debug해줌
                if (value == null) return;
                switch (value) {
                  case StepType.init:
                  case StepType.dataLoad:
                    Get.find<DataLoadController>()
                        .loadData(); //StepType이 dataLoad의 경우, DataLoadContoller의 loadData를 실행
                    break;
